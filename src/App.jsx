...
function App() {
  ...
  const {
    ...
    swapChannels,
    toggleSwapChannels
  } = useAudioController(speechFile, 'audio/anl_noise.flac', 0); // Offset 0 to match MCL range
  ...
  return (
    <div className="app-container">
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1>Hearing Aid Noise Tolerance Test <span style={{ fontSize: '0.8rem', opacity: 0.6, fontWeight: 'normal' }}>v1.0.29</span></h1>
          {patientName && (
